...
Ease = {
    ...
    Quad = {
        In = function(t) return t^2 end,
        Out = function(t) return t*(2-t) end,
        InOut = function(t) return t<0.5 and 2*t^2 or -1+(4-2*t)*t end
    },
    ...
    Quart = {
        ...
        Out = function(t) return 1-(t-1)^4 end,
        InOut = function(t) return t<0.5 and 8*t^4 or 1-8*(t-1)^4 end
    },

    Quint = {
        In = function(t) return t^5 end,
        Out = function(t) return 1+(t-1)^5 end,
        InOut = function(t) return t<0.5 and 16*t^5 or 1+16*(t-1)^5 end
    },

    Sext = {
        In = function(t) return t^6 end,
        Out = function(t) return 1-(t-1)^6 end,
        InOut = function(t) return t<0.5 and 32*t^6 or 1-32*(t-1)^6 end
    },
    ...
    Hyper = {
        In = function(t) return math.sinh(t*3)/math.sinh(3) end,
        Out = function(t) return 1-math.cosh(-t*3)/math.cosh(3) end,
        InOut = function(t) return (math.sinh(t*6)/math.sinh(6)+1)/2 end
    },
